...
class BinaryTree {
  ...
  /** minDepth(): returns the min. depth of tree -- that is,
  ...
  /** maxDepth(): returns max. depth of the tree -- that is,
  ...
  /** maxSum(): returns max. sum you can obtain by traveling along a path in the tree.
  ...
  /** nextLarger(lowerBound): returns smallest value in the tree
   * which is larger than lowerBound. Returns null if no such value exists. */
